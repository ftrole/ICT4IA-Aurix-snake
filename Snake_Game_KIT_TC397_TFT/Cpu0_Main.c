 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title Snake game for Aurix KIT_TC397_TFT
 * \abstract Snake game for Aurix KIT_TC397_TFT.
 * \description A joystick is used to control the snake. A led matrix is used as display
 * \name Snake game for Aurix KIT_TC397_TFT
 * \version V1.0.0
